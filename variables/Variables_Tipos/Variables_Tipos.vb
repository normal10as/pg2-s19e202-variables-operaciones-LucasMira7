...
Module Variables_Tipos
    Sub Main(args As String())
        ...
        Console.WriteLine("Altura Corporal: " & AlturaCorporal & "cm.")
        Console.WriteLine("Nacionalidad: " & Nacionalidad)
        Console.WriteLine("Temperatura Ambiente: " & TemperaturaAmbiente & "°C")
        Console.WriteLine("Nombre de la Calle: " & NombreCalle)
        Console.WriteLine("Altura de la Calle: " & AlturaCalle)
        Console.WriteLine("Distancia entre 2 Ciudades Cualquiera: " & DistanciaEntre2Ciudades & "km.")
        Console.WriteLine("Profundidad del Mar: " & ProfundidadMar & "m.")
